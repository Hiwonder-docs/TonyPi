...
3)  若颜色识别不准确可参照下文"**调节颜色阈值**"，对颜色阈值进行设置。
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Color_Warning.py)
...
[查看视频教程](#https://space.bilibili.com/470819482/search/video?keyword=tonyPI)

机器人对颜色进行识别，通过"点头"或"摇头"来对识别结果进行反馈。

我们看下本节课整体实现的流程：

(1) 首先需要对颜色进行识别，我们使用Lab颜色空间来进行处理(关于Lab颜色空间的这个部分可以前往 "[OpenCV计算机视觉学习](https://docs.hiwonder.com/projects/General_basic_courses/en/latest/docs/6_opencv.html)"进行详细学习)。

(2) 接着通过颜色阈值对圆圈中的物体颜色进行识别，再对图像部分进行掩膜（掩膜是用选定的图像、图形或物体，对处理的图像进行全局或者局部遮挡）。

(3) 然后经过对物品图片腐蚀膨胀处理后，最后将轮廓最大的物体用圆圈圈出。
...
(4) 接着根据识别的颜色进行判断，如果满足设定的颜色，即让头部舵机进行上下转动，否则进行左右转动。
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ColorDetect.py)
...
(1)  双击系统桌面<img src="../_static/media/8.ai_vision_games_lesson/3.1/image11.png" style="width:50px"  />图标，在弹出的界面中点击"**执行**"。

<img src="../_static/media/8.ai_vision_games_lesson/3.1/image12.png" class="common_img" />
...
<img src="../_static/media/8.ai_vision_games_lesson/3.1/image11.png" class="common_img" />
...
<img src="../_static/media/8.ai_vision_games_lesson/3.1/image23.png" class="common_img" />
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ColorPositionRecognition.py)
...
(2)  在树莓派的桌面双击的"**Terminator**"图标<img src="../_static/media/8.ai_vision_games_lesson/4.1/image3.png" style="width:45px" />，打开命令行终端输入**指令**，按下回车则可定位到存放了玩法程序的目录。
...
:::{Note}
程序默认识别和跟随的颜色为绿色。如需切换蓝色或红色，可参下文 **4.4 功能延伸\ 更换默认识别的颜色**。另外手持彩色海绵方块移动时速度不宜过快，并应满足摄像头识别的范围。
:::
...
<img src="../_static/media/8.ai_vision_games_lesson/4.1/image7.png" style="width:100%"  />
...
<img src="../_static/media/8.ai_vision_games_lesson/4.1/image8.png"  style="width:100%"  />
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Follow.py)
...
首先需要对颜色进行识别，我们使用Lab颜色空间来进行处理(关于Lab颜色空间的这个部分可以前往"[OpenCV计算机视觉学习](https://docs.hiwonder.com/projects/General_basic_courses/en/latest/docs/6_opencv.html)"进行详细学习)。
...
(2)  在树莓派的桌面双击的"**Terminator**"图标<img src="../_static/media/8.ai_vision_games_lesson/5.1/image2.png" style="width:45px" />，打开命令行终端。
...
<img src="../_static/media/8.ai_vision_games_lesson/5.1/image6.png"  style="width:100%" />
...
<img src="../_static/media/8.ai_vision_games_lesson/5.1/image7.png" style="width:100%"  />
...
<img src="../_static/media/8.ai_vision_games_lesson/5.1/image10.png" class="common_img"  />
...
<img src="../_static/media/8.ai_vision_games_lesson/5.1/image14.png" class="common_img"  />
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/KickBall.py)
...
(2)  在树莓派的桌面双击的"**Terminator**"图标<img style="width:45px" src="../_static/media/8.ai_vision_games_lesson/6.1/image2.png"  />，打开命令行终端。
...
:::{Note}
程序默认识别颜色为红色。如需切换黑色或白色，可参下文**6.4 功能延伸\更换默认巡线的颜色**。
:::
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/VisualPatrol.py)
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Tag_Detect.py)
...
(2)  在树莓派的桌面双击的"**Terminator**"图标<img style="width:45px" src="../_static/media/8.ai_vision_games_lesson/8.1/image2.png"  />，打开命令行终端。
...
<img src="../_static/media/8.ai_vision_games_lesson/8.1/image12.png" width="100%"  />

(3)  接着需要把这5行代码进行粘贴，将鼠标光标移动如下图所示的位置上：

<img src="../_static/media/8.ai_vision_games_lesson/8.1/image13.png" width="100%" />

(4)  键盘输入"**p**"即可将前面复制的5行代码粘贴至下方：

<img src="../_static/media/8.ai_vision_games_lesson/8.1/image14.png" width="100%" />

(5)  然后可对复制的代码进行修改，输入"**i**"进入编辑模式，将tag_id修改为4，AGC.runActionGroup内的动作组修改为chest（欢呼动作）。

可前往路径"**/home/pi/TonyPi/ActionGroups**"查看内置动作组文件。

<img src="../_static/media/8.ai_vision_games_lesson/8.1/image15.png" width="100%" />

(6)  至此我们已完成标签增加及对应动作的修改，最后按下"**Esc**"进入末行命令模式，输入"**:wq**"即可保存退出。（先输入英文:，再输入wq）

(7)  在本节目录下的"**ApirlTag标签集合**"文件夹内找到ID4标签，可自行打印出来。

<img src="../_static/media/8.ai_vision_games_lesson/8.1/image16.png"  width="100%"/>

(8)  通过前面所学命令行执行本节程序，验证效果：

<img src="../_static/media/8.ai_vision_games_lesson/8.1/image17.png" width="100%" />

### 8.5 程序简要分析

[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ApriltagDetect.py)
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Face_Detect.py)
...
(2)  在树莓派的桌面双击的"**Terminator**"图标<img style="width:45px" src="../_static/media/8.ai_vision_games_lesson/10.1/image2.png"  />，打开命令行终端。
...
[下载源代码](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/FaceDetect.py)
