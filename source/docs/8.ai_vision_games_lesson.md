...
The source code of this program is saved in: [/home/pi/TonyPi/Functions/Color_Warning.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Color_Warning.zip)
...
:::{Note}
The program defaults to recognizing the color red. To switch to blue or green, refer to "[4.2.5 Function Extension->Modify Default Recognition Color](#anchor_4_5_5)".
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/ColorDetect.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ColorDetect.zip)
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/2.1/image14.png"  width="840px" />
...
(7) The default recognized color can be set as red according to the [Modify Default Recognition Color](#anchor_4_5_5) in this text.
...
- If color recognition is inaccurate, refer to the section "[4.3.5 Function Extension\Adjusting Color Threshold](#anchor_4_3_5)" in this document to adjust the color threshold settings.
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/ColorPositionRecognition.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ColorPositionRecognition.zip)
...
:::{Note}
The default recognized and tracking color is green. If you want to change to blue or red, please refer to [4.4.5 Function Extension -> Modify Default Recognition Color](#anchor_4_5_5). Furthermore, when moving the handheld colored sponge blocks, the speed should not be too fast, and it should be within the range of camera recognition.
:::
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/Follow.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Follow.zip)
...
(7) The default recognized color can be set as red according to the [4.4.5 Function Extension -> Modify Default Recognition Color](#anchor_4_5_5) in this text.
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/KickBall.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/KickBall.zip)
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to [4.5.5 Program Analysis->Import parameter module](#anchor_4_5_4) .
...
The source code of this program is locate in [/home/pi/TonyPi/Functions/VisualPatrol.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/VisualPatrol.zip)
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to "[4.6.4 Program Analysis -> Import parameter module](#anchor_4_5_4)".
...
(4) Press "**i**" to enter the editing mode, then modify black in "_**target_color = ('black')**" to red. If you want to recognize white, please revise to "**white**".
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/6.1/image13.png" width="840px" />
...
(7) The default tracking color can be set as black according to the "[4.6.5 Function Extension -> Modify Default Tracking Color](#anchor_4_6_5)" in this text.
...
The source code for this program is located at : [/home/pi/TonyPi/Functions/Tag_Detect.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Tag_Detect.zip)
...
The source code of this program is locate in: [/home/pi/TonyPi/Functions/ApriltagDetect.py.](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/ApriltagDetect.zip)
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to "[4.8.4 Program Analysis -> Import parameter module](#anchor_8_5_1)".
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image6.png" width="700px" />
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image11.png" width="100%" />
...
<img class="common_img" src="../_static/media/8.ai_vision_games_lesson/8.1/image17.png" width="640px" />
...
(1)  Power on the device and, following the instructions in "[Remote Desktop Installation and Connection\3.1 Remote Desktop Installation and Connection](https://docs.hiwonder.com/projects/TonyPi/en/latest/docs/6.remote.html#id1)", use the VNC remote connection tool to connect.
...
### 4.9.4 Program Analysis 

The source code of the program is saved in:[/home/pi/TonyPi/Functions/Face_Detect.py ](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/Face_Detect.zip)
...
The source code of this program is locate in: "[/home/pi/TonyPi/Functions/FaceDetect.py](https://store.hiwonder.com.cn/docs/TonyPi/source_code/8/FaceDetect.zip)".
