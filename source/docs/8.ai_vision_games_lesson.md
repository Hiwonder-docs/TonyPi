...
10) 再按照“[**4.2 更换默认识别颜色**](#anchor_1_4_2)”1~4步骤，打开程序文件并按下“i”键进入编辑模式，接着找到如下图所示代码。
...
14) 参照“[1.2 玩法开启及关闭步骤](#anchor_1_2)”再次启动该玩法，将紫色物品放置到摄像头前，课在回传画面中看到紫色框出，并打印“purple”。如果需要改为默认识别颜色，参照“[4.2 更换默认识别颜色](#anchor_1_4_2)”将颜色改为紫色即可。
...
<img src="../_static/media/8.ai_vision_games_lesson/6.1/image1.png" style="width:40px" />程序默认识别颜色为红色。如需切换黑色或白色，可参下文**6.4 功能延伸\更换默认巡线的颜色**。
