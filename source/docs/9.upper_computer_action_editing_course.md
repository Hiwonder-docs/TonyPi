...
Achieving goal：Execute the action group in the folder "[5.3 Action Group Programming](#anchor_3)" through mobile APP custom function. Here, we take the example of performing weightlifting actions.
...
<img src="../_static/media/15.upper_computer/5.1/image6.png" style="300px"   /> 

<img src="../_static/media/15.upper_computer/5.1/image7.png" style="300px" />
...
:::{Note}
The action group file must be saved in the directory "/home/pi/TonyPi/ActionGroups". If you want to call a custom action group, please refer to "[5.3 Action Group Programming](#anchor_3)" for action editing.
:::
