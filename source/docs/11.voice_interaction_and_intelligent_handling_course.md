...
Distinguished from the color tracking effect in "[**5. AI Vision Projects**](https://docs.hiwonder.com/projects/TonyPi/en/latest/docs/8.ai_vision_games_lesson.html)" here is the effect of the body movement.
...
<img class="common_img"  src="../_static/media/11.intelligent_transport/5.1/image14.png"  width="100%" />
...
(7) The default tracking color can be set as black according to the "[**7.2.5 Function Extension -> Modify Default Recognition Color**](#anchor_7_2_5)" in this text.
